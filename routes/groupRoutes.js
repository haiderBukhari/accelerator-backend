...
import { addBackgroundPicture, addProfilePicture, approvePendingUser, createGroup, getGroups, getGroupUsers, getJoinedGroupDetails, getSpecificGroup, joinGroup, likeGroup, removeUser, toggleGroupPrivacy } from '../controller/groupController.js';
...
groupRoutes.route('/:id').get(getSpecificGroup).put(likeGroup)
