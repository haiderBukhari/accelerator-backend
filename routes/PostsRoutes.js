...
import { getIndividualPersonPosts, getPosts, likePost, uploadPost, uploadText } from '../controller/postsController.js';
...
PostsRoutes.route('/').get(getPosts).post(uploadText).patch(likePost);
